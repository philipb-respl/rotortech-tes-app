 ...
 *  the app's acknowledgement that the TES really moved, so it stays until
 *  dismissed. `path`/`driveUrl` are filled in only when a PDF actually
 *  exists in Drive, which is not the case until the upload is ported to an
 *  Edge Function; until then the modal just confirms the submission. */
